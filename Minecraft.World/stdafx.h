...
/* Emscripten/WASM builds use the PSVita code path.
 * Define __PSVITA__ early so that all platform branches below resolve
 * correctly even when wasm_platform_override.h was not force-included. */
#if (defined(__EMSCRIPTEN__) || defined(__wasm__)) && !defined(__PSVITA__)
#define __PSVITA__ 1
#define __psp2__   1
#define _PSVita    1
#endif
